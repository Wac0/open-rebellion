...
- [x] (2026-09-09) Replaced the browser custom text menu and visible setup page with the binary-mapped shuttle cockpit, direct faction start, and single-loop MDATA.302 music. Astra-medium R2 exercised the full browser matrix and R3 passed the corrected 11/11 commit gate. Evidence: `../qa/2026-09-08-full-functionality-audit/evidence/2026-09-09-main-menu-cockpit.md`.
- [ ] Close the remaining P03/P04 endpoints, downstream settings propagation, native/accessibility, gain/mute, return-to-menu, and second-campaign-reset gates in `../../agent_docs/main-menu-parity.md`.
...
- [ ] M0: complete native GUI restart acceptance and browser persistence hardening. Browser Save/Load/Delete, HD/troop-data paths, the self-contained browser package, F-011A fingerprints, and the F-011B1 v10 continuation envelope are verified; command replay, data hashes, and cross-runtime equivalence remain open.
