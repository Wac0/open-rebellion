...
- [ ] Close the remaining P03/P04 endpoints, native/accessibility, gain/mute, return-to-menu, and clean second-campaign-reset gates in `../../agent_docs/main-menu-parity.md`.
