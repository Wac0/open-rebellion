...
startup, F-001 browser Save/Load/Delete, the F-011A fingerprint primitive, and
the F-011B1 save-continuation envelope now pass. Long-running command replay,
native/WASM checkpoint parity, tactical parity, remaining browser
