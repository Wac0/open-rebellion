...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-500%20passing-green.svg" alt="Tests">
...
> **Verification (2026-09-09):** The original cockpit now passes browser functional acceptance: exact bitmap controls, both faction/setup paths, Credits, explicit multiplayer status, save/options audio controls, clean campaign reset, the correct `MDATA.300` *Return of the Jedi* cue, and recovered button effects. All 500 workspace tests pass. Native interactive visuals, semantic canvas accessibility, multiplayer networking, and broader release gates remain tracked in the [audit](docs/qa/2026-09-08-full-functionality-audit/) and [menu reference](agent_docs/main-menu-parity.md); historical files are in the [archive](archive/INDEX.md).
