...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Tests-518%20passing-green.svg" alt="Tests">
...
> **Verification (2026-09-09):** The cockpit passes native and browser acceptance. Replay format v1 now records and executes checkpointed commands, survives save-v11 reload, and produces stable native fingerprints across fresh processes with all 51 simulation DAT inputs. All 518 workspace tests pass. Native/WASM replay equivalence, multiplayer, and broader release gates remain in the [audit](docs/qa/2026-09-08-full-functionality-audit/), [replay reference](agent_docs/deterministic-replay.md), and [menu reference](agent_docs/main-menu-parity.md).
